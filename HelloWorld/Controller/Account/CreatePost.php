...
use Mageplaza\HelloWorld\Helper\Data as CustomerHelper;
...
class CreatePost extends AbstractAccount implements CsrfAwareActionInterface, HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $name = $this->getRequest()->getParam('firstname');
            $url_key = $this->getRequest()->getParam('prefix');
            $email_customer = $this->getRequest()->getParam('email');

            $this->CustomerHelper->saveNewCustomer($name, $url_key,$email_customer);
            ...
            $this->messageManager->addSuccessMessage(__('Se han guardado los datos con éxito en la tabla custom.'));
            $resultRedirect->setPath('customer/account');
            return $resultRedirect;
    ...
    protected function getSuccessMessage()
    {
        if ($this->addressHelper->isVatValidationEnabled()) {
            ...
            $message = __('Se han guardado los datos con éxito en la tabla custom.', $this->storeManager->getStore()->getFrontendName());
        }
        return $message;
    }
    ...
    private function getMessageManagerSuccessMessage(): MessageInterface
    {
        if ($this->addressHelper->isVatValidationEnabled()) {
            ...
            $message = $this->messageManager
                ...
                ->setText(
                    __('Se han guardado los datos con éxito en la tabla custom', $this->storeManager->getStore()->getFrontendName())
                );
        }
